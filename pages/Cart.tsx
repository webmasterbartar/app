...
const Cart: React.FC = () => {
  ...
  const { totalRaw, totalDiscount, payable } = items.reduce((acc, item) => {
    ...
    // Fallback: if originalPrice is missing or lower than price, use price
  ...
  return (
    <div className="bg-[#f8f9fa] min-h-screen pb-32 font-persian" dir="rtl">
       
       {/* Header */}
       <header className="bg-white/80 backdrop-blur-md px-4 py-4 sticky top-0 z-20 shadow-sm flex items-center justify-between">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 p-4 pb-6 max-w-md mx-auto z-30 shadow-[0_-5px_20px_rgba(0,0,0,0.05)]">
        <button className="w-full bg-[#ef4056] text-white py-3.5 rounded-xl font-bold shadow-lg shadow-red-200 hover:bg-[#d63044] transition-all active:scale-[0.98] flex items-center justify-center gap-2">
